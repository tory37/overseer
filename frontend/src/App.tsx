...
import { Terminal as TerminalIcon, X, Layout, Maximize2, Ghost, Rocket, Check, GitBranch, Info, Plus, Play, ExternalLink, Trash2, Folder, Home } from 'lucide-react' // Added Folder and Home icons
