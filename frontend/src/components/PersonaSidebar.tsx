...
import { Ghost, Search, Settings, Terminal, Folder, Plus, Trash2, Zap, Bot } from 'lucide-react';
  ...
  return (
    <aside className="w-64 border-r border-slate-800 flex flex-col bg-slate-900/80 backdrop-blur-md h-full">
      ...
      <div className="p-3 border-t border-slate-800/60 bg-slate-950/40 space-y-1">
        ...
        <button onClick={() => onOpenSpecialView('agent-library')} className={footerBtn(specialView === 'agent-library')}>
